provider "okta" {
  ...
  "okta.profileMappings.manage", "okta.profileMappings.read", "okta.groups.read", "okta.groups.manage", "okta.users.read", "okta.users.manage", "okta.trustedOrigins.read", "okta.trustedOrigins.manage"]
